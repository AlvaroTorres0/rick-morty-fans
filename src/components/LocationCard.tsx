  ...
  return (
    <div id={`${id}`} className="card w-96 lg:w-[500px] bg-base-100 shadow-xl">
        <div className="card-body flex flex-col justify-center items-center gap-2">
            <h2 className="card-title font-principal-bold text-4xl text-center">{ name }</h2>
