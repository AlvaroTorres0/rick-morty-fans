  ...
  return (
    <div className='bg-[#1C1C1CBB] w-4/5 md:w-3/4 lg:w-[600px] rounded-lg px-14 py-16 flex flex-col gap-10'>
      ...
      <form action="" className='flex flex-col gap-4'>
        ...
        <button className='btn primary-color-500 primary-text-color'>
          {
        ...
        <p>
          ...
          <u className='cursor-pointer font-principal-semibold'>
            {
              formType === 'login' ? 'Regístrate aquí' : 'Inicia sesión'
            }
          </u>
        </p>
      </form>
